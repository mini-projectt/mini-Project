...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const b_front = path.join(
        __dirname,
        "..",
        order.item.images.front
      );

      const b_back = path.join(
        __dirname,
        "..",
        order.item.images.back
      );

      const b_left = path.join(
        __dirname,
        "..",
        order.item.images.left
      );

      const b_right = path.join(
        __dirname,
        "..",
        order.item.images.right
      );
